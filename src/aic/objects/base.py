...
from onevision import Color
from onevision import euclidean_distance
from onevision import get_box_corners_points
from onevision import majority_voting
...
class BaseObject:
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        Args:
            id_ (int, str):
                Object unique ID.
            detection (list, Detection, optional):
                List of all detections of this object. Default: `None`.
            timestamp (float):
                Time when the object is created.
            frame_index (int):
                Frame index when the object is created.
    ...
    def current_class_label(self) -> dict:
        ...
        return self.detections[-1].class_label
    ...
    def current_roi_id(self) -> Union[int, str]:
        ...
        return self.detections[-1].roi_id
...
class BaseMovingObject(BaseObject, metaclass=abc.ABCMeta):
    """Base Moving Object.
    ...
    def update(self, detection: Detection, **kwargs):
        ...
        Args:
            detection (Detection):
                Detection of the object.
        """
        super(BaseMovingObject, self).update(detection=detection, **kwargs)
