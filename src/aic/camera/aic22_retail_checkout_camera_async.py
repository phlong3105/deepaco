...
from aic.camera.aic22_retail_checkout_camera import AIC22RetailCheckoutCamera
...
# MARK: - AIC22RetailCheckoutCameraAsync
...
class AIC22RetailCheckoutCameraAsync(AIC22RetailCheckoutCamera):
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        super().__init__(
            ...
            detector        = detector,
            tracker         = tracker,
            hands_estimator = hands_estimator,
        ...
        self.hands_queue      = Queue(maxsize=self.queue_size)
    ...
    def run(self):
        ...
        # NOTE: Threading for hand estimator
        thread_hand_estimator = threading.Thread(target=self.run_hands_estimator)
        thread_hand_estimator.start()
    ...
    def run_hands_estimator(self):
        ...
        while True:
            ...
            self.hands_queue.put([images, indexes, files, rel_paths, batch_hands])
    ...
    def run_detector(self):
        ...
        while True:
            ...
            self.detections_queue.put([images, indexes, files, rel_paths, batch_detections, batch_hands])
    ...
    def run_tracker(self):
        ...
        while True:
            ...
            images, indexes, files, rel_paths, batch_detections, batch_hands = self.detections_queue.get()
